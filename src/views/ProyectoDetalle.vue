...
<template>
  <v-container>
    ...
    <v-card v-if="proyecto" class="mb-4">
      ...
      <v-card-text>
        <v-row class="mb-2">
          <v-col cols="12" md="4"><strong>Fecha:</strong> {{ fmtDate(proyecto.fecha) }}</v-col>
          <v-col cols="12" md="4"><strong>Mina:</strong> {{ proyecto.mina }}</v-col>
          <v-col cols="12" md="4"><strong>Equipo:</strong> {{ proyecto.equipo }}</v-col>
        </v-row>
        <v-row>
          <v-col cols="12" md="4"><strong>Habilitado estimado:</strong> {{ fmtCurrency(proyecto.habilitado_estimado ?? proyecto['habilitado_estimado']) }}</v-col>
          <v-col cols="12" md="4"><strong>Días trabajados:</strong> {{ proyecto['días_trabajados'] ?? proyecto['dias_trabajados'] ?? proyecto.dias_trabajados }}</v-col>
          <v-col cols="12" md="4"><strong>Trabajadores por día:</strong> {{ proyecto['números_de_trabajadores_por_dia'] ?? proyecto['numeros_de_trabajadores_por_dia'] ?? proyecto.numeros_de_trabajadores_por_dia }}</v-col>
        </v-row>
        <v-row>
          <v-col cols="12" md="4"><strong>Tareas por día:</strong> {{ proyecto.numero_de_tareas_por_dia }}</v-col>
        </v-row>
      </v-card-text>
    </v-card>
    ...
    <div class="d-flex justify-end mb-3">
      <v-btn variant="tonal" class="mr-2" @click="$router.push(`/proyectos/${id}/seguimiento`)">Seguimiento</v-btn>
